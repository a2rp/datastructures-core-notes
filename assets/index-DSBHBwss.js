...
// Average O(1)`})]})]})]})]})})},ko={Wrapper:J.section`
    ...
    `},$m=()=>{const[o,a]=Ve.useState(!0);return l.jsx(ko.Wrapper,{children:l.jsxs(ko.Container,{className:o?"open":"",children:[l.jsxs(ko.Header,{onClick:()=>a(!o),children:[l.jsxs("div",{className:"left",children:[l.jsx("div",{className:"icon",children:l.jsx(pt,{})}),l.jsxs("div",{children:[l.jsx("h2",{children:"Linear Data Structures"}),l.jsx("p",{children:"Memory in sequence"})]})]}),l.jsx("div",{className:"right",children:o?l.jsx(xr,{}):l.jsx(gr,{})})]}),o&&l.jsxs(ko.Content,{children:[l.jsx("div",{className:"intro",children:"Linear data structures store elements in a sequential manner. Each element has a single predecessor and successor except the first and last. Understanding memory layout here builds the base for trees, graphs, and advanced structures."}),l.jsxs("div",{className:"focus",children:["Mental Focus:",l.jsx("br",{}),"Contiguous vs Non-contiguous memory",l.jsx("br",{}),"Access cost vs Insertion cost"]}),l.jsxs("div",{className:"grid",children:[l.jsxs("div",{className:"card",children:[l.jsxs("div",{className:"cardHead",children:[l.jsx(Ad,{}),l.jsx("h3",{children:"Array"})]}),l.jsx("p",{children:"Stores elements in contiguous memory locations. Fast access using index."}),l.jsx("p",{className:"mini",children:"Access: O(1) | Insert: O(n)"}),l.jsx("pre",{children:`int arr[5] = {1,2,3,4,5};
...
priority_queue<int> pq;`})]}),l.jsxs("div",{className:"card",children:[l.jsxs("div",{className:"cardHead",children:[l.jsx(Yt,{}),l.jsx("h3",{children:"Priority Queue"})]}),l.jsx("p",{children:"Abstract structure using heap internally."}),l.jsx("pre",{children:"priority_queue<int, vector<int>, greater<int>> pq; // min heap"})]})]}),l.jsxs("div",{className:"mental",children:[l.jsx("h4",{children:"Mental Focus"}),l.jsx("p",{children:"Recursion is natural in trees. Height determines time complexity. Divide and conquer patterns emerge here."})]})]})]})})},Co={Wrapper:J.section`
    ...
    `},Qm=()=>{const[o,a]=Ve.useState(!0);return l.jsx(Co.Wrapper,{children:l.jsxs(Co.Container,{className:o?"open":"",children:[l.jsxs(Co.Header,{onClick:()=>a(!o),children:[l.jsxs("div",{className:"left",children:[l.jsx("div",{className:"icon",children:l.jsx(cf,{})}),l.jsxs("div",{children:[l.jsx("h2",{children:"Graphs"}),l.jsx("p",{children:"Connectivity thinking"})]})]}),l.jsx("div",{className:"right",children:o?l.jsx(xr,{}):l.jsx(gr,{})})]}),o&&l.jsxs(Co.Content,{children:[l.jsx("div",{className:"intro",children:"Graphs model relationships. Whenever data is about connections between entities, graphs are the natural structure. Social networks, road maps, dependencies, routing systems — all are graphs. The mental focus here is traversal patterns."}),l.jsxs("div",{className:"grid",children:[l.jsxs("div",{className:"card",children:[l.jsxs("div",{className:"cardHead",children:[l.jsx(pt,{}),l.jsx("h3",{children:"Graph Basics"})]}),l.jsx("p",{children:"A graph consists of vertices (nodes) and edges (connections between nodes)."}),l.jsx("pre",{children:`// V = vertices
// E = edges
...
int sum(int i){
  ...
  return s;
    ...
    `},Gm=()=>{const[o,a]=Ve.useState(!0);return l.jsx(_o.Wrapper,{children:l.jsxs(_o.Container,{children:[l.jsxs(_o.Header,{onClick:()=>a(!o),children:[l.jsxs("div",{className:"left",children:[l.jsx("div",{className:"icon",children:l.jsx(pt,{})}),l.jsxs("div",{children:[l.jsx("h2",{children:"Algorithmic Patterns"}),l.jsx("p",{children:"This is gold"})]})]}),l.jsx("div",{className:"right",children:o?l.jsx(xr,{}):l.jsx(gr,{})})]}),o&&l.jsxs(_o.Content,{children:[l.jsx("div",{className:"intro",children:"Algorithmic patterns are reusable thinking models. Instead of solving problems randomly, you recognize structure. If you master patterns, you solve entire classes of problems instead of single questions."}),l.jsxs("div",{className:"grid",children:[l.jsxs("div",{className:"card",children:[l.jsxs("div",{className:"cardHead",children:[l.jsx(vr,{}),l.jsx("h3",{children:"Two Pointers"})]}),l.jsx("p",{children:"Use two indices moving through a structure. Often used in sorted arrays."}),l.jsx("pre",{children:`// Find pair with sum = target
int l = 0, r = n - 1;
while(l < r){
    int sum = arr[l] + arr[r];
    if(sum == target) break;
...
// because of cache locality`}),l.jsx("p",{className:"mini",children:"Complexity gives growth trend, not exact runtime."})]})]})]})]})})},Km=()=>{const o=Ve.useRef(null),[a,c]=Ve.useState("overview"),f=[["overview","Overview",l.jsx(Lm,{})],["foundations","Foundations",l.jsx(pt,{})],["linearDataStructures","Linear structures",l.jsx(Om,{})],["hashBasedStructures","Hash tables",l.jsx(Tm,{})],["trees","Trees",l.jsx(Yt,{})],["graphs","Graphs",l.jsx(cf,{})],["advancedStructures","Advanced structures",l.jsx(Fm,{})],["algorithmicPatterns","Algorithmic patterns",l.jsx(ui,{})],["complexityMaster","Complexity guide",l.jsx(pt,{})]],m=w=>{var N;c(w),(N=o.current)==null||N.scrollTo({top:0,left:0,behavior:"smooth"})};return l.jsxs(qs.Wrapper,{children:[l.jsx(qs.Header,{children:l.jsx(Mm,{})}),l.jsxs(qs.Main,{ref:o,children:[l.jsxs("aside",{className:"studyNav","aria-label":"Data structures topics",children:[l.jsx("div",{className:"studyNavLabel",children:"Study guide"}),l.jsx("nav",{children:f.map(([w,N,P])=>l.jsxs("button",{type:"button",className:a===w?"active":"",onClick:()=>m(w),children:[P,l.jsx("span",{children:N})]},w))}),l.jsx("p",{children:"Select a topic to open its notes."})]}),l.jsxs("div",{className:"contentWrapper",children:[a==="overview"&&l.jsx(Wm,{}),l.jsx("div",{className:`topicWrapper ${a==="foundations"?"activeTopic":""}`,children:l.jsx(Um,{})}),l.jsx("div",{className:`topicWrapper ${a==="linearDataStructures"?"activeTopic":""}`,children:l.jsx($m,{})}),l.jsx("div",{className:`topicWrapper ${a==="hashBasedStructures"?"activeTopic":""}`,children:l.jsx(Vm,{})}),l.jsx("div",{className:`topicWrapper ${a==="trees"?"activeTopic":""}`,children:l.jsx(bm,{})}),l.jsx("div",{className:`topicWrapper ${a==="graphs"?"activeTopic":""}`,children:l.jsx(Qm,{})}),l.jsx("div",{className:`topicWrapper ${a==="advancedStructures"?"activeTopic":""}`,children:l.jsx(Ym,{})}),l.jsx("div",{className:`topicWrapper ${a==="algorithmicPatterns"?"activeTopic":""}`,children:l.jsx(Gm,{})}),l.jsx("div",{className:`topicWrapper ${a==="complexityMaster"?"activeTopic":""}`,children:l.jsx(qm,{})})]}),l.jsx("div",{className:"footerWrapper",children:l.jsx(Bm,{})})]})]})};vh.createRoot(document.getElementById("root")).render(l.jsx(l.Fragment,{children:l.jsx(Km,{})}));
